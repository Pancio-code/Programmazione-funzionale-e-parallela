...
// do_test
// ---------------------------------------------------------------------
static int do_test(const short* min, unsigned minn,
                   const short* v,   unsigned n,
...
int main(int argc, char** argv) {
    ...
    ok += do_test(min, N-M,   v, N,     max, N,     1); // res == 1
    ok += do_test(min, N,     v, N-M,   max, N,     2); // res == 1
    ok += do_test(min, N,     v, N,     max, N-M,   3); // res == 1
    ok += do_test(min, N,     v, N,     max, N,     4); // res == 0
    ok += do_test(min, N-M+2, v, N-M+2, max, N-M+2, 5); // res == 0
